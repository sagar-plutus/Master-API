...
namespace ODLMWebAPI.Models
{
    public class TblFilterReportTO
    {
        ...
        public String AlternateApiName { get => alternateApiName; set => alternateApiName = value; }
        public string AdminUserIds { get => adminUserIds; set => adminUserIds = value; }
