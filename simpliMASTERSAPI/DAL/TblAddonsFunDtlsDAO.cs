...
" VALUES (" +
         ...
         //   " ,@IdAddonsfunDtls " +
           ...
           // cmdInsert.Parameters.Add("@IdAddonsfunDtls", System.Data.SqlDbType.Int).Value = tblAddonsFunDtlsTO.IdAddonsfunDtls;
            ...
            cmdInsert.Parameters.Add("@IsMarked", System.Data.SqlDbType.Int).Value = tblAddonsFunDtlsTO.IsMarked;
        ...
        //    cmdUpdate.Parameters.Add("@IdAddonsfunDtls", System.Data.SqlDbType.Int).Value = tblAddonsFunDtlsTO.IdAddonsfunDtls;
            ...
            cmdUpdate.Parameters.Add("@IsMarked", System.Data.SqlDbType.Int).Value = tblAddonsFunDtlsTO.IsMarked;
        ...
        public List<TblAddonsFunDtlsTO> ConvertDTToList(SqlDataReader tblAddonsFunDtlsTODT)
        {
            ...
            if (tblAddonsFunDtlsTODT != null)
            {
                while (tblAddonsFunDtlsTODT.Read())
                {
                    ...
                    if (tblAddonsFunDtlsTODT["isMarked"] != DBNull.Value)
                        tblAddonsFunDtlsTONew.IsMarked = Convert.ToInt32(tblAddonsFunDtlsTODT["isMarked"].ToString());
                    tblAddonsFunDtlsTONew.IsMarkedImp = false;
                    if (tblAddonsFunDtlsTONew.IsMarked == 1)
                        tblAddonsFunDtlsTONew.IsMarkedImp = true;
