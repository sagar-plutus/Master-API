...
namespace ODLMWebAPI.DAL
{
    public class TblOtherTaxesDAO : ITblOtherTaxesDAO
    {
        ...
        public List<TblOtherTaxesTO> ConvertDTToList(SqlDataReader tblOtherTaxesTODT)
        {
            ...
            if (tblOtherTaxesTODT != null)
            {
                while (tblOtherTaxesTODT.Read())
                {
                    ...
                    if (tblOtherTaxesTODT["IsTaxCalulated"] != DBNull.Value)
                        tblOtherTaxesTONew.IsTaxCalulated  = Convert.ToBoolean(tblOtherTaxesTODT["IsTaxCalulated"].ToString());
                    if (tblOtherTaxesTODT["IsAmtAddOrDed"] != DBNull.Value)
                        tblOtherTaxesTONew.IsAmtAddOrDed = Convert.ToBoolean(tblOtherTaxesTODT["IsAmtAddOrDed"].ToString());
        ...
        public TblOtherTaxesTO SelectTblOtherTaxes(Int32 idOtherTax,SqlConnection conn,SqlTransaction tran)
        {
        ...
        public int ExecuteInsertionCommand(TblOtherTaxesTO tblOtherTaxesTO, SqlCommand cmdInsert)
        {
            ...
            cmdInsert.Parameters.Add("@IsTaxCalulated", System.Data.SqlDbType.Bit).Value = tblOtherTaxesTO.IsTaxCalulated;
            cmdInsert.Parameters.Add("@IsAmtAddOrDed", System.Data.SqlDbType.Bit).Value = tblOtherTaxesTO.IsAmtAddOrDed;
