...
namespace ODLMWebAPI.DAL
{
    public class TblOrgAddressDAO : ITblOrgAddressDAO
    {
        ...
        #region Deletion
        public int DeleteTblOrgAddress(Int32 addrId)
        {
            String sqlConnStr = _iConnectionString.GetConnectionString(Constants.CONNECTION_STRING);
            SqlConnection conn = new SqlConnection(sqlConnStr);
            ...
            try
            {
                ...
                return ExecuteDeletionOnAddressId(addrId, cmdDelete);
            }
            catch(Exception ex)
            {
        ...
        private int ExecuteDeletionOnAddressId(Int32 addrId, SqlCommand cmdDelete)
        {
            cmdDelete.CommandText = "DELETE FROM [tblOrgAddress] " +
