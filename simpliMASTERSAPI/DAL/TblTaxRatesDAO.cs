...
namespace ODLMWebAPI.DAL
{
    public class TblTaxRatesDAO : ITblTaxRatesDAO
    {
        ...
        public List<TblTaxRatesTO> ConvertDTToList(SqlDataReader tblTaxRatesTODT)
        {
            ...
            if (tblTaxRatesTODT != null)
            {
                while (tblTaxRatesTODT.Read())
                {
                    ...
                    try
                    {
                        if (tblTaxRatesTODT["merchantExportSapTaxCode"] != DBNull.Value)
                            tblTaxRatesTONew.MerchantExportSapTaxCode = Convert.ToString(tblTaxRatesTODT["merchantExportSapTaxCode"].ToString());
                    }
                    catch (Exception ex)
                    {

                    }
                    if (tblTaxRatesTODT["directTypeCatTaxCode"] != DBNull.Value)
                        tblTaxRatesTONew.DirectTypeCatTaxCode = Convert.ToString(tblTaxRatesTODT["directTypeCatTaxCode"].ToString());
        ...
        public int ExecuteInsertionCommand(TblTaxRatesTO tblTaxRatesTO, SqlCommand cmdInsert)
        {
            ...
            cmdInsert.Parameters.Add("@SapTaxCode", System.Data.SqlDbType.NVarChar).Value = Constants.GetSqlDataValueNullForBaseValue(tblTaxRatesTO.SapTaxCode);
        ...
        public int ExecuteUpdationCommand(TblTaxRatesTO tblTaxRatesTO, SqlCommand cmdUpdate)
        {
            ...
            cmdUpdate.Parameters.Add("@sapTaxCode", System.Data.SqlDbType.NVarChar).Value = Constants.GetSqlDataValueNullForBaseValue(tblTaxRatesTO.SapTaxCode);
