...
namespace ODLMWebAPI.DAL.Interfaces
{
    public interface ITblSysEleUserEntitlementsDAO
    {
        ...
        List<TblSysEleUserEntitlementsTO> SelectAllTblSysEleUserEntitlements(int userId, int? moduleId);
        List<TblSysEleUserEntitlementsTO> SelectAllTblSysEleAllUserEntitlements(string userIds, int? moduleId);
        ...
        //harshala
        List<TblSysEleUserEntitlementsTO> SelectAllTblSysEleUserEntitlementsOnlyRW(int userId);
    }
}