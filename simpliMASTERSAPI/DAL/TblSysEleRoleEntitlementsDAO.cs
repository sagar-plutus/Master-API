...
namespace ODLMWebAPI.DAL
{
    public class TblSysEleRoleEntitlementsDAO : ITblSysEleRoleEntitlementsDAO
    {
        ...
        public Dictionary<int, String> SelectAllTblSysEleMultipleRoleEntitlementsDCT(String roleId,int? moduleId)
        {
            String sqlConnStr = _iConnectionString.GetConnectionString(Constants.CONNECTION_STRING);
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public List<TblSysEleRoleEntitlementsTO> SelectAllOFTblSysEleMultipleRoleEntitlementsDCT(string roleId)
        {
            String sqlConnStr = _iConnectionString.GetConnectionString(Constants.CONNECTION_STRING);
            SqlConnection conn = new SqlConnection(sqlConnStr);
            SqlCommand cmdSelect = new SqlCommand();
        ...
        public List<TblSysEleRoleEntitlementsTO> SelectAllTblSysEleRoleEntitlementsOnlyRW(int roleId)
        {
            ...
            try
            {
                ...
                cmdSelect.CommandText = SqlSelectQuery() + " LEFT JOIN tblSysElements sysele on tblSysEleRoleEntitlements.sysEleId = sysele.idSysElement  WHERE roleId=" + roleId + " and permission='RW' and not(type='m') and isDisplayToUser=1 ";
