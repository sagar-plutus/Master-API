...
namespace simpliMASTERSAPI.DAL.Interfaces
{
    public interface ITblPurchaseVehicleSpotEntryBL
    {
        ...
        List<TblPurchaseVehicleSpotEntryTO> SelectAllSpotEntryVehicles(DateTime fromDate, DateTime toDate,Int32 moduleId, String loginUserId, Int32 id, bool skipDatetime);
        ...
        ResultMessage UpdateSpotEntryVehicleSupplier(TblPurchaseVehicleSpotEntryTO tblPurchaseVehicleSpotEntryTO, int loginUserId);
    }
}